            ...
            if (templates.length > 0) {
                ...
                $.each(templates, function(i, template) {
                    templateTable.row.add([
                        ...
                        "<div class='text-center'><span data-toggle='modal' data-target='#modal'><button class='btn btn-outline blue btn-sm' data-toggle='tooltip' data-placement='left' title='Edit Template' onclick='edit(" + i + ")'>\
                    <i class='fa fa-pencil'></i>\
                    </button></span>\
		    <span data-toggle='modal' data-target='#modal'><button class='btn btn-outline purple btn-sm data-toggle='tooltip' data-placement='left' title='Copy Template' onclick='copy(" + i + ")'>\
                    <i class='fa fa-copy'></i>\
                    </button></span>\
                    <button class='btn btn-outline red btn-sm' data-toggle='tooltip' data-placement='left' title='Delete Template' onclick='deleteTemplate(" + i + ")'>\
